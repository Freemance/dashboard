...
import { ApolloLinkJwtArgs } from 'type/apollo-link-jwt';
...
export const apolloLinkJWT = ({
  ...
  const refreshTokens = async () => {
    ...
    if (isJwtExpired(cachedRefreshToken)) return 'Refresh token has expired';
    ...
    const onRefreshResponse = onRefreshComplete(response);
